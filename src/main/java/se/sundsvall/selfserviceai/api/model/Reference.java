...
public class Reference {
	...
	@Schema(description = "Id of the reference", example = "d0846e7e-a860-43d0-8bc2-d0a029c23381")
	private String id;

	@Schema(description = "Metadata for the reference")
	private Metadata metadata;

	@Schema(description = "Group id to which the reference belongs", example = "56839552-08b7-44e6-88eb-c4c524c0833b")
	private String groupId;

	@Schema(description = "Website id for the reference", example = "56839552-08b7-44e6-88eb-c4c524c0833b")
