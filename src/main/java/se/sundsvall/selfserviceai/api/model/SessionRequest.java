...
public class SessionRequest {
	...
	@Schema(description = "The id of the party to use when retrieving the information that will form the basis of the assistant's answers", examples = "5a6c3e4e-c320-4006-b448-1fd4121df828", requiredMode = REQUIRED)
	@ValidUuid
