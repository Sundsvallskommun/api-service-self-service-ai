...
public class Model {
	...
	@Schema(description = "Id of the model", example = "1f717b73-c676-4316-112e-cda43650d832")
	private String id;

	@Schema(description = "Name for the model", example = "gpt-4o-mini-azure")
	private String name;

	@Schema(description = "Nickname for the model", example = "GPT-4o mini (Azure)")
	private String nickname;

	@Schema(description = "Family to which the model belongs", example = "azure")
	...
	@Schema(description = "Hf link for model", example = "http://some.address")
	private String hfLink;

	@Schema(description = "Stability of the model", example = "stable")
	private String stability;

	@Schema(description = "Hosting for the model", example = "swe")
	...
	@Schema(description = "Organization owning the model", example = "Microsoft")
	private String org;
	...
	@Schema(description = "Base url for the model", example = "http://some.url")
