...
class IntricIntegrationTest {
	...
	void askAssistant_1() {
		...
		var input = "input";
		var sessionId = "2d357dcf-6180-48de-a9e8-3ad74b757c84";
		var answer = "answer";
		var response = AskResponse.builder()
		...
		var result = integration.askAssistant(assistantId, input);

		var askAssistant = askAssistantCaptor.getValue();
	...
	void askFollowUp_1() {
		...
		var result = integration.askFollowUp(assistantId, sessionId, input);
	...
	void askFollowUp_2() {
		...
		assertThat(result.answer()).isBlank();
		assertThat(result.question()).isEqualTo(input);
		assertThat(result.sessionId()).isEqualTo(UUID.fromString(sessionId));
		verify(intricClientMock).askFollowUp(assistantId, sessionId, askAssistant);
	}
	...
	void uploadFile_1() {
		...
		var id = "2d357dcf-6180-48de-a9e8-3ad74b757c84";
		var filePublic = FilePublic.builder()
		...
		var result = integration.uploadFile(multiPartFileMock);
	...
	@Test
	void deleteFile() {
		var fileId = "2d357dcf-6180-48de-a9e8-3ad74b757c84";
