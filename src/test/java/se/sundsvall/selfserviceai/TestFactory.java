...
public class TestFactory {
	...
	public static final Date IB1_END_DATE = Date.from(LocalDate.of(2025, 1, 10).atStartOfDay(ZoneId.systemDefault()).toInstant());
	public static final Date IB1_START_DATE = Date.from(LocalDate.of(2020, 1, 10).atStartOfDay(ZoneId.systemDefault()).toInstant());
	public static final Date IB1_LAST_MODIFIED_DATE = Date.from(LocalDate.of(2024, 1, 9).atStartOfDay(ZoneId.systemDefault()).toInstant());
	public static final String IB1_AGREEMENT1_ID = "agreementId1";
	public static final Date IB1_AGREEMENT1_START_DATE = Date.from(LocalDate.of(2020, 1, 11).plusWeeks(1).atStartOfDay(ZoneId.systemDefault()).toInstant());
	...
	public static final Date IB1_AGREEMENT2_START_DATE = Date.from(LocalDate.of(2020, 1, 12).atStartOfDay(ZoneId.systemDefault()).toInstant());
	...
	public static final Date IB1_INVOICE1_DATE = Date.from(LocalDate.of(2020, 2, 1).atStartOfDay(ZoneId.systemDefault()).toInstant());
	public static final Date IB1_INVOICE1_DUE_DATE = Date.from(LocalDate.of(2020, 2, 28).atStartOfDay(ZoneId.systemDefault()).toInstant());
	...
	public static final Date IB1_INVOICE2_DUE_DATE = Date.from(LocalDate.of(2024, 2, 13).atStartOfDay(ZoneId.systemDefault()).toInstant());
	public static final Date IB1_INVOICE2_DATE = Date.from(LocalDate.of(2024, 2, 28).atStartOfDay(ZoneId.systemDefault()).toInstant());
	...
	public static final Date IB2_START_DATE = Date.from(LocalDate.of(2021, 5, 15).atStartOfDay(ZoneId.systemDefault()).toInstant());
	public static final Date IB2_LAST_MODIFIED_DATE = Date.from(LocalDate.of(2024, 6, 30).atStartOfDay(ZoneId.systemDefault()).toInstant());
	public static final String IB2_AGREEMENT1_ID = "agreementId3";
	public static final Date IB2_AGREEMENT1_START_DATE = Date.from(LocalDate.of(2024, 5, 24).atStartOfDay(ZoneId.systemDefault()).toInstant());
